package ec.fin.online15.backend.librerias.excepciones;
...
public class ExcepcionParametrosQuerys extends ExcepcionFalloTecnico {
	...
	public ExcepcionParametrosQuerys(String codigoExcepcion,
	...
	public ExcepcionParametrosQuerys(String codigoExcepcion,
			String mensajeUsuario, String mensajeTecnico, Throwable cause) {
