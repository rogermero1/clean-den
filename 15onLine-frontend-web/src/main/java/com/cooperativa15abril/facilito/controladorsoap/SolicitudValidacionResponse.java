...
/**
 * <p>Clase Java para solicitudValidacionResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="solicitudValidacionResponse">
 *   &lt;complexContent>
...
@XmlType(name = "solicitudValidacionResponse", propOrder = {
    "_return"
})
public class SolicitudValidacionResponse {
