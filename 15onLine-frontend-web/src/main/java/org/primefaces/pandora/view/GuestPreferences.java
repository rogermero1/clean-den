...
public class GuestPreferences implements Serializable {
    ...
    private String componentTheme = "green-light";//"bluegrey-light";
    
    private String menuMode =  "layout-slim-plus";//"layout-horizontal";
    ...
    public String getLayoutConfigTemplateRegistro() {
        StringBuilder sb = new StringBuilder();
        String menuModeClass = "layout-horizontal";
        String menuThemeClass = "layout-menu-" + (this.menuColor.equals("colored") ? this.menuTheme : this.menuColor);
